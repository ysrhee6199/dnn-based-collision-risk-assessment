  ...
  if (isInitialized) {
    ...
    (static_cast<MWElementwiseAffineLayer *>(layers[1]))
        ->createElementwiseAffineLayer(
            targetImpl, layers[0]->getOutputTensor(0), 1, 1, 3, 1, 1, 3, false,
            1, 1, "./codegen/lib/Predict/cnn_decnet0_0_imageinput_scale.bin",
            "./codegen/lib/Predict/cnn_decnet0_0_imageinput_offset.bin", "SSCB",
            0);
    (static_cast<MWFusedConvActivationLayer *>(layers[2]))
        ->createFusedConvActivationLayer(
            targetImpl, 1, layers[1]->getOutputTensor(0), 3, 3, 3, 8, 1, 1, 1,
            1, 1, 1, 1, 1, 1,
            "./codegen/lib/Predict/cnn_decnet0_0_Convolution_Layer_1_w.bin",
            "./codegen/lib/Predict/cnn_decnet0_0_Convolution_Layer_1_b.bin",
    ...
    (static_cast<MWFusedConvActivationLayer *>(layers[4]))
        ->createFusedConvActivationLayer(
            ...
            1, 1, 1, 1, 1, 1,
            "./codegen/lib/Predict/cnn_decnet0_0_conv_1_w.bin",
            "./codegen/lib/Predict/cnn_decnet0_0_conv_1_b.bin", 0.0F,
    ...
    (static_cast<MWFusedConvActivationLayer *>(layers[6]))
        ->createFusedConvActivationLayer(
            ...
            1, 1, 1, 1, 1, 1,
            "./codegen/lib/Predict/cnn_decnet0_0_conv_2_w.bin",
            "./codegen/lib/Predict/cnn_decnet0_0_conv_2_b.bin", 0.0F,
            MWActivationFunctionType::ACTIVATION_FCN_ENUM::RELU, "SSCB", 1);
    (static_cast<MWFCLayer *>(layers[7]))
        ->createFCLayer(
            targetImpl, layers[6]->getOutputTensor(0), 40000, 13,
            "./codegen/lib/Predict/cnn_decnet0_0_fully_Connected_Layer_w.bin",
            "./codegen/lib/Predict/cnn_decnet0_0_fully_Connected_Layer_b.bin",
            "SSCB", 0);
...
decnet0_0::decnet0_0()
{
  ...
  inputTensors[0]->setHeight(201);
  inputTensors[0]->setWidth(101);
